(function ComponentsDicomEditorFiltersEqualizationInnerModule() {
  class EqualizationInner extends Components.DicomEditor.Filters.BaseFilter {
    constructor(props) {
      super(props);
    ...
    render() {
      return (
        <div>
          <label>inner equalization</label>
  ...
  EqualizationInner.propTypes = {

  }

  EqualizationInner.defaultProps = {

  }

  Components.DicomEditor.Filters.EqualizationInner = EqualizationInner;
})();
