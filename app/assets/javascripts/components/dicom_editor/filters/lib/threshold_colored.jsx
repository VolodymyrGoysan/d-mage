(function ComponentsDicomEditorFiltersColoredThresholdModule() {
  class ColoredThreshold extends Components.DicomEditor.Filters.BaseFilter {
    constructor(props) {
      super(props);
  ...
  ColoredThreshold.propTypes = {

  }

  ColoredThreshold.defaultProps = {

  }

  Components.DicomEditor.Filters.ColoredThreshold = ColoredThreshold;
})();
