(function LibImageFiltersEqualizationInnerModule() {
  const equalizationInner = (imageData, newImageData, options) => {
  ...
  Lib.ImageFilter.equalizationInner = equalizationInner;
})();
